...
true_labels_hiv$subcluster[labels(branch3a %>% merge(branch3b) %>% merge(branch3c) %>% merge(branch3d))] <- 3  # "D_3"
...
true_labels_hiv$subcluster[labels(branch11a %>% merge(branch11b) %>% merge(branch11c) )] <- 11  # "HA_11"
